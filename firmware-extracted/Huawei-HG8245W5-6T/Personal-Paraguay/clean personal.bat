...
echo/REALFIRMWARE.NET web& echo/ & mode con cols=77 lines=30

set "_usuario_=root" & set "_senha_=codigo123"
...
>"%temp%\_temp_file_4vbs_.vbs"^
    (
     ...
     echo/ WshShell.SendKeys "({ENTER})"
     echo/ Wscript.Sleep 200
     echo/ WshShell.SendKeys "ls"
     echo/ Wscript.Sleep 200
	 echo/ WshShell.SendKeys "({ENTER})"
	 echo/ Wscript.Sleep 200
	 echo/ WshShell.SendKeys "cd bin"
	 echo/ Wscript.Sleep 200
	 echo/ WshShell.SendKeys "({ENTER})"
     echo/ Wscript.Sleep 200
